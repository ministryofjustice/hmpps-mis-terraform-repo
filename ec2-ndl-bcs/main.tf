...
locals {
  ...
  nart_role          = "ndl-bcs-${data.terraform_remote_state.common.legacy_environment_name}"
...
#-------------------------------------------------------------
### Create secondary instance - NDL-BCS-002
#-------------------------------------------------------------
...
#-------------------------------------------------------------
### Create third instance - NDL-BCS-003
#-------------------------------------------------------------
...
#-------------------------------------------------------------
# Create route53 entry for instance 3
#-------------------------------------------------------------

resource "aws_route53_record" "instance_003" {
  count   = "${var.bcs_deploy_tertiary ? 1 : 0 }"
  zone_id = "${local.private_zone_id}"
