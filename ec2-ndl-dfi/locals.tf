locals {
  ...
  domain_host_name               = "ndl-dfi-${local.standard_nart_prefix}1.${var.environment_name}.local"
  ...
  dfi_server_stopped_msg         = "Server stopped"
  dfi_server_started_msg         = "Server started"
