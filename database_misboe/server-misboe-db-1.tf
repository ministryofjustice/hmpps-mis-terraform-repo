...
module "misboe_db_1" {
  ...
  ansible_vars = {
    ...
    database_backup_location      = "${var.ansible_vars_misboe_db["database_backup_location"]}"
...
output "ami_misboe_db_1" {
  value = "${module.misboe_db_1.ami_id}"
}

output "public_fqdn_misboe_db_1" {
  value = "${module.misboe_db_1.public_fqdn}"
}

output "internal_fqdn_misboe_db_1" {
  value = "${module.misboe_db_1.internal_fqdn}"
}

output "private_ip_misboe_db_1" {
  value = "${module.misboe_db_1.private_ip}"
}

output "db_disks_misboe_db_1" {
  value = "${module.misboe_db_1.db_size_parameters}"
}

# map (tidier)
output "misboe_db_1" {
  value = {
    ami_id        = "${module.misboe_db_1.ami_id}",
    public_fqdn   = "${module.misboe_db_1.public_fqdn}",
