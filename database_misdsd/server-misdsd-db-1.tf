...
module "misdsd_db_1" {
  ...
  ansible_vars = {
    ...
    database_backup_location      = "${var.ansible_vars_misdsd_db["database_backup_location"]}"
...
output "public_fqdn_misdsd_db_1" {
  value = "${module.misdsd_db_1.public_fqdn}"
}

output "internal_fqdn_misdsd_db_1" {
  value = "${module.misdsd_db_1.internal_fqdn}"
}

output "private_ip_misdsd_db_1" {
  value = "${module.misdsd_db_1.private_ip}"
}
