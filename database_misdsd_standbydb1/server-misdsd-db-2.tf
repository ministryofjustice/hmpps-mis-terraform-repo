module "misdsd_db_2" {
  ...
  ansible_vars = {
    ...
    database_global_database_name = "${var.ansible_vars_misdsd_db["database_global_database_name"]}S1"
    database_sid                  = "${var.ansible_vars_misdsd_db["database_sid"]}S1"
...
output "misdsd_db_2" {
  value = {
    ami_id        = module.misdsd_db_2.ami_id
    public_fqdn   = module.misdsd_db_2.public_fqdn
    ...
    misdsd_db_2   = "ssh ${module.misdsd_db_2.public_fqdn}"
  }
}
